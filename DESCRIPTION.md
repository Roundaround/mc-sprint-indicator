...
<details>
<summary><b>Configuration — <code>sprintindicator.toml</code></b></summary>
...
<!-- modrinth:only -->
Also on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/sprint-indicator) · [Source on GitHub](https://github.com/Roundaround/mc-sprint-indicator) · [Report an issue](https://github.com/Roundaround/mc-sprint-indicator/issues)
<!-- /modrinth:only -->
<!-- curseforge:only -->
Also on [Modrinth](https://modrinth.com/mod/sprint-indicator) · [Source on GitHub](https://github.com/Roundaround/mc-sprint-indicator) · [Report an issue](https://github.com/Roundaround/mc-sprint-indicator/issues)
<!-- /curseforge:only -->
